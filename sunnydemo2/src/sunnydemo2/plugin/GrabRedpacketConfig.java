...
public class GrabRedpacketConfig {
    ...
    /**抢红包服务连接与断开连接**/
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "sunnydemo2.plugin.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "sunnydemo2.plugin.ACCESSBILITY_CONNECT";

    /**通知栏服务连接与断开连接**/
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "sunnydemo2.plugin.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "sunnydemo2.plugin.NOTIFY_LISTENER_CONNECT";
